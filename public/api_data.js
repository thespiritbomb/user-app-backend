    ...
    api: [
                ...
                fields: {
                    "Success 200": [
                        ...
                        },
                        {
                            ...
                            field: "x64signature",
                            description:
                                "<p>User fingerprint client signature</p>",
                        },
                        {
                            group: "Success 200",
                            type: "Boolean",
                            ...
                            field: "curlRequest",
                            description:
                                "<p>When making request using curl</p>",
                        },
                    ],
                },
                examples: [
        ...
        },
        {
            ...
            sampleRequest: [
                {
                    url:
                        "https://user-form-backend.herokuapp.com/v1/json/user/:userHash",
                },
            ],
        },
        {
            ...
            sampleRequest: [
                {
                    url:
                        "https://user-form-backend.herokuapp.com/v1/json/user/",
                },
            ],
        },
    ],
